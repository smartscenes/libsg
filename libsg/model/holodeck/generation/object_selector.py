...
from libsg.model.holodeck.generation.floor_objects import DFS_Solver_Floor
from libsg.model.holodeck.generation.objaverse_retriever import ObjathorRetriever
from libsg.model.holodeck.generation.utils import get_bbox_dims, get_annotations
from libsg.model.holodeck.generation.wall_objects import DFS_Solver_Wall
...
class ObjectSelector:
    ...
    def plan_room(self, args):
        ...
        output_1 = self.llm.invoke(prompt_1)
        plan_1 = self.extract_json(output_1.content)
        ...
        if floor_capacity[1] / floor_capacity[0] >= required_floor_capacity_percentage:
            ...
            output_2 = self.llm.invoke(prompt_2).content
