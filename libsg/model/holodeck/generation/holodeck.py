...
from libsg.model.holodeck.constants import (
...
from libsg.model.holodeck.generation.layers import map_asset2layer
from libsg.model.holodeck.generation.lights import generate_lights
...
from libsg.model.holodeck.generation.skybox import getSkybox
from libsg.model.holodeck.generation.small_objects import SmallObjectGenerator
from libsg.model.holodeck.generation.utils import get_top_down_frame, room_video
...
class Holodeck:
    ...
    def get_empty_scene(self):
        return compress_json.load("/localhome/hip4/project/t2s/Holodeck/ai2holodeck/generation/empty_house.json")
    ...
    def generate_variants(
        ...
        used_assets += [
            obj["assetId"] for obj in original_scene["objects"] + original_scene["windows"] + original_scene["doors"]
        ]
        ...
        for i in tqdm(range(number_of_variants)):
            ...
            used_assets += [
                obj["assetId"] for obj in variant_scene["objects"] + variant_scene["windows"] + variant_scene["doors"]
            ]
